...
class ProductEntry:
    ...
    def __init__(self, product_id, jewellery_type, metal, gem):
    ...
    def as_str(self):
        return f"Produto: {self.product_id}, Tipo: {self.jewellery_type}, Metal: {self.metal}, Jóia: {self.gem}"
    
    @classmethod
    def from_binary(cls, data):
        product_id, jewellery_bytes, metal_bytes, gem_bytes = struct.unpack('q20s20s20s', data)
        ...
        return cls(product_id, jewellery_type, metal, gem)
